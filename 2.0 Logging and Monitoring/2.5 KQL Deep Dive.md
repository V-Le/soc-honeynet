...
### Log Analytics Workspace KQL Tables
- `SecurityEvents` - Windows VMs
- `Syslog` - Linux VMs
- `AzureDiagnostics` - Azure SQL Server, Azure Key Vault
- `AzureNetworkAnalytics_CL` - Network security Groups
- `StorageBlobLogs` - Azure Blob Storage
